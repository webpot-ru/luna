...
const CHINESE_BUILD_REPORT = path.join(ROOT, "outputs/hsk/qa/hsk3_level_6_1400_v1_chinese_examples_build_20260608.json");
const CLASSIC_TARGET_REPORT = path.join(ROOT, "outputs/hsk/qa/hsk3_level_6_1400_v1_classic_target_translation_build_20260608.json");
...
const EXPECTED_CLASSIC_READY_ROWS = 736;
const EXPECTED_HSK3_ONLY_ROWS = 664;
const EXPECTED_FILLED_NON_ENGLISH_CELLS = 71_400;
...
if (rows.length !== 1400) issue(blockers, "row_count", `Expected 1400 workbook rows, found ${rows.length}`);

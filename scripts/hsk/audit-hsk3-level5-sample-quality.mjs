...
const artifactRegex =
  /(?:^|[\s,;:()[\]{}"'“”¿?¡!])(?:todo|tbd|fixme|null|undefined|translation|example)(?:$|[\s,;:()[\]{}"'“”¿?¡!])|[?？]{3,}|…{2,}/iu;
...
const report = {
  ...
  sample_policy: {
    ...
    sample_scope: "10 filled workbook rows per target language after Level 5 reached complete_53_languages_filled.",
  },

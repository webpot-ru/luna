...
const forcedReviewKeys = new Set(["1574:千克", "1582:公斤"]);
...
const report = {
  ...
  notes: [
    ...
    "Level 4 forces the unit rows 1574:千克 and 1582:公斤 through all target languages in addition to the hash sample.",
  ],
};

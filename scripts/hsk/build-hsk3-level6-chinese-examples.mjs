...
const manualTsvPath = path.join(ROOT, "config/hsk3-level6-manual-examples.tsv");
const examplesOut = path.join(ROOT, "config/hsk3-level6-examples.json");
const glossesOut = path.join(ROOT, "config/hsk3-level6-en-glosses.json");
...
const report = {
  ...
  notes: [
    ...
    "Rows without row-level Classic reuse must be authored in config/hsk3-level6-manual-examples.tsv.",

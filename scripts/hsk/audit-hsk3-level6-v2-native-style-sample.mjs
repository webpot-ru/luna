...
const report = {
  ...
  notes: [
    ...
    "Level 6 v2 forces legacy disambiguated duplicate/source-homonym rows plus corrected-boundary high-risk rows 5164:一帆风顺, 5328:中, 5330:中毒, 5331:中奖, 5333:中暑 and 5399:钻 through all target languages in addition to the hash sample.",
  ],
};

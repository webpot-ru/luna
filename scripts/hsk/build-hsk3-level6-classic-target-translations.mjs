...
const TRANSLATIONS_OUT = path.join(ROOT, "config/hsk3-level6-classic-reuse-target-translations.json");
...
const report = {
  ...
  notes: [
    ...
    "EN/EN-GB pivot cells are handled by config/hsk3-level6-en-glosses.json and config/hsk3-level6-examples.json.",

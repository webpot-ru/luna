...
const forcedReviewKeys = new Set(["2467:行", "2539:系", "3149:头"]);
...
const report = {
  ...
  notes: [
    ...
    "Level 5 forces the reading-difference rows 2467:行 and 2539:系 plus neutral suffix/source row 3149:头 through all target languages in addition to the hash sample.",
  ],
};

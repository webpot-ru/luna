...
const manualTsvPath = path.join(ROOT, "config/hsk3-level5-manual-examples.tsv");
const examplesOut = path.join(ROOT, "config/hsk3-level5-examples.json");
const glossesOut = path.join(ROOT, "config/hsk3-level5-en-glosses.json");
...
const report = {
  ...
  notes: [
    ...
    "Rows without row-level Classic reuse must be authored in config/hsk3-level5-manual-examples.tsv.",

...
function usage() {
  return [
    ...
    "  npm run dispatch:youtube-bulk-publish -- --apply --schedule-start-date=YYYY-MM-DD --confirm-dispatch=DISPATCH_YOUTUBE_BULK --confirm-youtube-write=APPLY_YOUTUBE_UPLOAD",
    "",
    ...
    "--metadata-gemini-backend=api,vectorengine --metadata-batch-size=10 --metadata-rate-limit-ms=15000.",

...
const BASE_BATCH_ID = "es_article_display_v1";
const BATCH_ID = "es_419_article_display_v1";
const SCRIPT_PATH = "scripts/oxford/build-oxford-part003-support-translation-batch-es-419.mjs";
...
const SPAIN_SPANISH_RISK_RE =
  /\b(ordenador|zumo|vaqueros|coche|billete|coste|nata|móvil|patata|bocadillo|aparcar|aparcamos|echar de menos|echo de menos|hacia delante|jersey|vosotros|vuestro|vuestra|vuestros|vuestras|bolígrafo|autobús)\b/iu;

const LATAM_OVERRIDES = {
  metre: ["el metro", "Camina un metro hacia adelante."],
  miss: ["extrañar; perder", "Extraño mi escuela anterior."],
  natural: ["natural", "Este jugo es natural."],
  need: ["necesitar", "Necesito una pluma."],
  next: ["siguiente", "El siguiente bus llega tarde."],
  park: ["estacionar; el parque", "Estacionamos cerca de la estación."],
  pen: ["la pluma", "Esta pluma es azul."],
  potato: ["la papa", "Como una papa."],
  sandwich: ["el sándwich", "Como un sándwich."],
  show: ["mostrar", "Muéstrame tu boleto."],
  slow: ["lento", "El bus es lento."],
};
...
function buildSupportRow(row, regionalized, generatedAt) {
  return {
    ...
    support_translation_source: "codex_regionalized_from_es_part003_support_batch_with_latin_america_overrides_not_oxford",
    support_example_source: "codex_regionalized_from_es_part003_support_batch_with_latin_america_overrides_not_oxford",

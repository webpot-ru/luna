...
const SCRIPT_PATH = "scripts/oxford/build-oxford-part002-support-translation-batch-hy.mjs";
const DEFAULT_TRANSLATIONS_PATH =
  "config/oxford_3000_core_a1_part_002_300_v1_support_translation_batch_hy_v1.tsv";
...
async function parseTranslations(filePath) {
  ...
  for (const [index, line] of lines.entries()) {
    ...
    if (LATIN_RE.test(display) || LATIN_RE.test(example)) {
      throw new Error(`Armenian row for ${sourceHeadword} contains Latin-script text`);
    }
...
await writeFile(
  ...
  [
    ...
    "- Script-aware validation: HY Armenian native script, Armenian display/example presence, sentence punctuation, Latin leak guard and unexpected-script leak guard",

...
const SCRIPT_PATH = "scripts/oxford/build-oxford-a2-part003-support-translation-batch-hi.mjs";
const DEFAULT_TRANSLATIONS = "config/oxford_3000_core_a2_part_003_202_v1_support_translation_batch_hi_v1.tsv";
const SENTENCE_END_RE = /[.!?]$/u;
const DEVANAGARI_RE = /\p{Script=Devanagari}/u;
const UNEXPECTED_SCRIPT_RE =
  /[A-Za-z\u0370-\u03FF\u0400-\u04FF\u0590-\u05FF\u0600-\u06FF\u0980-\u09FF\u0B80-\u0BFF\u0C00-\u0C7F\u0C80-\u0CFF\u0D00-\u0D7F\u0E00-\u0E7F\u0E80-\u0EFF\u1780-\u17FF\u3040-\u30FF\u3400-\u9FFF\uAC00-\uD7AF]/u;
...
async function parseTranslations(filePath) {
  ...
  if (header !== "source_headword\tHI\texample_HI") {
    throw new Error(`Unexpected HI translation TSV header in ${filePath}`);
  }
  const map = new Map();
  for (const [index, line] of lines.entries()) {
    ...
    assertHindiText(display, `${sourceHeadword} HI`);
    assertHindiText(example, `${sourceHeadword} example_HI`);
...
function buildSupportRow(exampleRow, translation, generatedAt) {
  return {
    ...
    reviewer: "codex_oxford_a2_part003_support_translation_batch_hi_v1",
...
await writeFile(
  ...
  [
    ...
    `- Languages: ${LANGUAGE}`,
    "- Article display: not included for Hindi",

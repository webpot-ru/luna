...
const SCRIPT_PATH = 'scripts/oxford/build-oxford-a2-part002-support-translation-batch-kk.mjs';
...
function buildSupportRow(exampleRow, translation, generatedAt) {
  return {
    ...
    reviewer: 'codex_oxford_a2_part002_support_translation_batch_kk_v1',

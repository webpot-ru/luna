...
const SCRIPT_PATH = "scripts/oxford/build-oxford-a2-part001-support-translation-batch-es.mjs";
const DEFAULT_TRANSLATIONS =
  "config/oxford_3000_core_a2_part_001_300_v1_support_translation_batch_es_article_display_v1.tsv";
...
function buildSupportRow(exampleRow, translation, generatedAt) {
  return {
    ...
    reviewer: "codex_oxford_a2_part001_support_translation_batch_es_article_display_v1",

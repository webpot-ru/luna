...
const SCRIPT_PATH = 'scripts/oxford/build-oxford-a2-part002-support-translation-batch-my.mjs';
...
function buildSupportRow(exampleRow, translation, generatedAt) {
  return {
    ...
    reviewer: 'codex_oxford_a2_part002_support_translation_batch_my_v1',
...
function main() {
  ...
  writeFileSync(
    ...
    [
      ...
      '- Script-aware validation: MY Burmese native Myanmar orthography, Burmese display/example presence, sentence punctuation and unexpected-script leak guard',

...
const SCRIPT_PATH = "scripts/oxford/build-oxford-b1-part001-support-translation-batch-da.mjs";
const DEFAULT_TRANSLATIONS = `config/${RELEASE_ID}_support_translation_batch_da_article_display_v1.tsv`;
...
function buildSupportRow(exampleRow, translation, generatedAt) {
  return {
    ...
    reviewer: "codex_oxford_b1_part001_support_translation_batch_da_article_display_v1",

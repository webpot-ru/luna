...
const SCRIPT_PATH = "scripts/oxford/build-oxford-a2-part002-support-translation-batch-th.mjs";
const DEFAULT_TRANSLATIONS = "config/oxford_3000_core_a2_part_002_300_v1_support_translation_batch_th_v1.tsv";
...
async function parseTranslations(filePath) {
  ...
  for (const [index, line] of lines.entries()) {
    ...
    if (THAI_TOKENIZATION_SPACE_RE.test(example)) {
      throw new Error(`Bad TH example tokenization for ${sourceHeadword}: spaces between Thai tokens are not allowed`);
    }
...
function buildSupportRow(exampleRow, translation, generatedAt) {
  return {
    ...
    reviewer: "codex_oxford_a2_part002_support_translation_batch_th_v1",

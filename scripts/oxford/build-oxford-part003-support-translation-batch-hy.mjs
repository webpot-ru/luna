...
const SCRIPT_PATH = "scripts/oxford/build-oxford-part003-support-translation-batch-hy.mjs";
const DEFAULT_TRANSLATIONS_PATH =
  "config/oxford_3000_core_a1_part_003_300_v1_support_translation_batch_hy_v1.tsv";
...
function buildSupportRow(row, translation, generatedAt) {
  return {
    ...
    article_display_policy: "not_applicable_no_article_layer_for_hy",
...
function updateContract(contract, batchPath, summaryPath, rows) {
  ...
  contract.next_stage_options = [
    "Generate TR support-language translations/examples for Part 003 in the Oxford English-learning contour.",
    "Continue support-language translations/examples in documented order after TR.",
...
await writeFile(
  ...
  [
    ...
    "- Script-aware validation: HY Armenian native script, Armenian display/example presence, sentence punctuation, no Latin fallback and unexpected-script leak guard",

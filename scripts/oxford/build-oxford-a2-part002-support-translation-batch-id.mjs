...
const SCRIPT_PATH = "scripts/oxford/build-oxford-a2-part002-support-translation-batch-id.mjs";
const DEFAULT_TRANSLATIONS = "config/oxford_3000_core_a2_part_002_300_v1_support_translation_batch_id_v1.tsv";
...
async function parseTranslations(filePath) {
  ...
  for (const [index, line] of lines.entries()) {
    ...
    assertIndonesianText(display, `${sourceHeadword} ID`);
    assertIndonesianText(example, `${sourceHeadword} example_ID`);
...
function buildSupportRow(exampleRow, translation, generatedAt) {
  return {
    ...
    reviewer: "codex_oxford_a2_part002_support_translation_batch_id_v1",

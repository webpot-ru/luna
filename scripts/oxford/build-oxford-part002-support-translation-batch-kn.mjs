...
const SCRIPT_PATH = "scripts/oxford/build-oxford-part002-support-translation-batch-kn.mjs";
const DEFAULT_TRANSLATIONS_PATH =
  "config/oxford_3000_core_a1_part_002_300_v1_support_translation_batch_kn_v1.tsv";
...
await writeFile(
  ...
  [
    ...
    "- Script-aware validation: KN Kannada native Kannada orthography, Kannada display/example presence, sentence punctuation and unexpected-script leak guard",

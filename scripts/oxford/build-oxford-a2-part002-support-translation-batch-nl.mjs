...
const SCRIPT_PATH = "scripts/oxford/build-oxford-a2-part002-support-translation-batch-nl.mjs";
const DEFAULT_TRANSLATIONS = "config/oxford_3000_core_a2_part_002_300_v1_support_translation_batch_nl_v1.tsv";
...
async function parseTranslations(filePath) {
  ...
  for (const [index, line] of lines.entries()) {
    ...
    assertDutchText(display, `${sourceHeadword} NL`);
    assertDutchText(example, `${sourceHeadword} example_NL`);
...
function buildSupportRow(exampleRow, translation, generatedAt) {
  return {
    ...
    reviewer: "codex_oxford_a2_part002_support_translation_batch_nl_v1",
...
await writeFile(
  ...
  [
    ...
    `- Languages: ${LANGUAGE}`,
    "- Article display: enabled where grammatically useful for Dutch nouns",

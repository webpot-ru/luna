...
const SCRIPT_PATH = "scripts/oxford/build-oxford-part002-support-translation-batch-ne.mjs";
const DEFAULT_TRANSLATIONS_PATH =
  "config/oxford_3000_core_a1_part_002_300_v1_support_translation_batch_ne_v1.tsv";
const SENTENCE_END_RE = /[.!?।]$/u;
const DEVANAGARI_RE = /\p{Script=Devanagari}/u;
const UNEXPECTED_SCRIPT_RE =
  /[\u0400-\u04FF\u0590-\u05FF\u0600-\u06FF\u0980-\u09FF\u0B80-\u0BFF\u0C00-\u0C7F\u0C80-\u0CFF\u0D00-\u0D7F\u0E00-\u0E7F\u0E80-\u0EFF\u1780-\u17FF\u3040-\u30FF\u3400-\u9FFF\uAC00-\uD7AF]/u;
...
await writeFile(
  ...
  [
    ...
    "- Script-aware validation: NE Nepali native Devanagari orthography, Nepali display/example presence, sentence punctuation and unexpected-script leak guard",

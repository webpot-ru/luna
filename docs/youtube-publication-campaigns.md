...
На 2026-07-14 run `29317134907` финализирован как второй zero-upload failure: 4/4 metadata routes получили обрезанный JSON из-за локального output cap, все 306 render/upload children были пропущены, finalizer зафиксировал `0` completed/observed/artifacts/receipt errors. Исправленная recovery campaign `yt-home_kitchen_cooking_actions_a1_a2-2026-07-14-51321f6fa942` / manifest `e5a188973d684038cd0196795acb01761ebec314c37e9c6cf3ba4577d728819a` сохраняет те же `306/306` assignments, route split `72/78/78/78` и schedule `2026-07-14T11:45:00Z..2026-07-17T18:30:00Z`. PR `#15` смержен в main SHA `b9ae5416`; один fire-and-forget dispatch создан как run `29320229328`, без watch/retries. Единственный начальный readback: `in_progress`; результаты ещё не классифицированы.
